...
class DqnAgent(Agent):
    ...
    POLICY_FILENAME = 'checkpoint.pth'
    def __init__(self, state_size, action_size, seed, load_policy=False):
        ...
        self.qnetwork_target = QNetwork(state_size, action_size, seed) \
                               .to(device)
        if load_policy:
            filename = os.path.join(Agent.POLICY_DIR, DqnAgent.POLICY_FILENAME)
