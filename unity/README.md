...
# Gathering Bananas with Deep Q-Learning

### Introduction

Here we have successfully trained an agent to navigate (and collect bananas!) in a large, square world.
...
**Our agent was able to achieve a score of approximately `+15`.**
